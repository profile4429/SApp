...
import com.example.sapp.adapter.DienThoaiAdapter;
import com.example.sapp.model.SanPhamMoi;
import com.example.sapp.retrofit.ApiBanHang;
import com.example.sapp.retrofit.RetrofitClient;
...
public class DienThoaiActivity extends AppCompatActivity {
    ...
    private void getData(int page) {
        ...
        .subscribe(
                ...
                throwable -> {
                    Toast.makeText(getApplicationContext(), "Ko ket noi dc sever", Toast.LENGTH_SHORT).show();
                }
        ));
    }
